...
std::vector<std::pair<std::string, float>> RAG_retrieve(std::vector<std::pair<std::string, std::vector<float>>>& rag_database, const std::string& embedding_model, const std::string& query, size_t top_n) {
